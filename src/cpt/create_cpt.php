...
use andyp\cpt\syllabus\register\taxonomy;
use andyp\cpt\syllabus\register\tags;
use andyp\cpt\syllabus\register\post_type;


/**
 * Register the custom post-type parts
 * - the CPT
 * - taxonomy
 * - tags
 */
