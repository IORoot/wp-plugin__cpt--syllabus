...
<div class="w-full">
    ...
    <a href="<?php echo get_term_link($current_term); ?>" class="subcat_box flex flex-col h-80 mb-4 rounded-2xl relative overflow-hidden bg-gray-200 text-black fill-green-500 hover:text-white hover:fill-white hover:bg-syllabus-500 hover:animate-pulse">
